...
<script type="text/javascript">
  jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
      ...
      colModel: [
        {label: 'ID', name: 'id', index: 'id', width: 20, sorttype: "int", key: true, editable: true, hidden: true},
        {label: '类型', name: 'type.id', index: 'type.id', width: 20, editable: true, sortable: true},
        ...
        {label: '档案日期', name: 'docDate', index: 'docDate', width: 40, editable: true, sortable: false},
        {label: '档案分类', name: 'category.id', index: 'category.id', width: 30, editable: true, edittype: 'select', ajaxEditOptions: {dataUrl: ctx + '/admin/dept/1.action'}},
        ...
        {label: '紧急程度', name: 'urgentLevel.id', index: 'urgentLevel.id', width: 30, sortable: false, editable: true}
      ],
      viewrecords: true,
      rowNum: 10,
      rowList: [10, 20, 30],
