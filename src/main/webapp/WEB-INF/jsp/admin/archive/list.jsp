    ...
    jQuery(grid_selector).jqGrid({
      ...
      colModel: [
        ...
        },
        {
          ...
          editable: true,
          edittype:"select",
          editoptions: {value: ${actionBean.typeList}}
        },
        {label: '年度', name: 'year', width: 20, editable: true, sortable: false},
        {label: '文件字号', name: 'docNo', width: 40, editable: true, sortable: false},
        {label: '标题', name: 'title', width: 150, editable: true, sortable: false},
        {
          label: '档案日期',
          name: 'docDate',
          sorttype: "date",
        ...
        {label: '保管期限', name: 'deadLine.id', width: 30, editable: true},
        {label: '公文种类', name: 'docClass.id', width: 30, editable: true},
        {label: '责任人', name: 'responsible', width: 30, editable: true},
        {label: '保密级别', name: 'privacyLevel.id', width: 30, sortable: false},
        {
          label: '紧急程度',
          name: 'urgentLevel.id',
...
//            caption: "jqGrid with inline editing"
    ...
    function style_edit_form(form) {
      ...
      form.find('input[name=docDate]').datepicker({format: 'yyyy-mm-dd', autoclose: true})
