...
import k0n9.common.web.resolver.BaseArgumentResolver;
 ...
 * @version 1.0
 */
public class MyActionBeanPropertyBinder implements ActionBeanPropertyBinder {

    private static final Log log = Log.getInstance(MyActionBeanPropertyBinder.class);

    private Configuration configuration;

    private BaseArgumentResolver baseArgumentResolver;
